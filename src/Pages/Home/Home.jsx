    ...
    return (
        <>
            ...
            <div className="vertical-layout vertical-menu  navbar-floating footer-static  " data-open="hover" data-menu="vertical-menu" data-col="">
                ...
                {/* BEGIN: Footer */}
                <footer className="footer footer-static footer-light footer-shadow">
                    <p className="clearfix mb-0"><span className="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a className="ms-25" href="https://1.envato.market/pixinvent_portfolio" target="_blank" rel="noreferrer">Pixinvent</a><span className="d-none d-sm-inline-block">, All rights Reserved</span></span><span className="float-md-end d-none d-md-block">Hand-crafted & Made with<i data-feather="heart"></i></span></p>
                </footer>

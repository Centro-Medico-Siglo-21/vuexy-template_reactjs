                ...
                <nav className="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-shadow container-xxl navbar-light">
                    <div className="navbar-container d-flex content">
                        ...
                        <ul className="nav navbar-nav align-items-center ms-auto">
                            ...
                            <li className="nav-item d-none d-lg-block"><a className="nav-link nav-link-style"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-moon ficon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg></a></li>
